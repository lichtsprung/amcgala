 ...
 * Objekten aus Blender moeglich (siehe exsample Paket) <br/> <br/>
 * <b>ACHTUNG!</b> : Export als Stanford (.ply) File ohne Normalen Vektoren
 * !<br/> Einstellungen lassen sich im Export Kontextmenue von zB Blender
 * festlegen. <br/> <i>Eigenschaft: "Normals"</i>
 *
...
public class PLYPolygonParser {
    ...
    /**
     * Parst .ply File und gibt Polygone zurueck<br/> <br/> <b>ACHTUNG!</b> :
     * Export als Stanford (.ply) File ohne Normalen Vektoren ! <br/>
    ...
    public static List<Polygon> parseAsPolygonList(InputStream inputStream,
        ...
        while (scanner.hasNext() && scanner.hasNextLine()) {
            ...
            if (currentLine.matches("element vertex [0-9]{1,5}")) {
                vertexCount = Integer.parseInt(currentLine.substring(15).trim());
            }
        ...
        for (int i = 0; i < faceCount; i++) {
            ...
            if (currentFace == 4) {
                polygons.add(new Polygon(vertices.get(scanner.nextInt()), vertices.get(scanner.nextInt()),
                                   vertices.get(scanner.nextInt()), vertices.get(scanner.nextInt())));
            } else if (currentFace == 3) {
                polygons.add(new Polygon(vertices.get(scanner.nextInt()), vertices.get(scanner.nextInt()),
                                   vertices.get(scanner.nextInt())));
            } else {
        ...
        log.info("loaded " + vertexCount + " vertexes and "
                 + faceCount + " faces");
        return polygons;
