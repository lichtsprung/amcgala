...
public final class ErosionHydraulic {
    ...
    public final static Channel erode1(Channel channel, Channel rain_map, float vaporization, int rain_freq, int iterations) {
        ...
        System.out.print("Hydraulic erosion 1: ");
    ...
    public final static Channel erode2(Channel channel, Channel rain_map, float vaporization, int rain_freq, int iterations) {
        Channel water_map = new Channel(channel.width, channel.height).fill(0f);
        Channel vapor_map = rain_map.copy().multiply(0.5f);
        Channel water_map_diff = new Channel(channel.width, channel.height).fill(0f);

        System.out.print("Hydraulic erosion 2: ");
    ...
    public final static Channel erode3(Channel channel, Channel rain_map, float vaporization, int rain_freq, int iterations) {
        Channel vapor_map = rain_map.copy().multiply(0.5f);
        ...
        System.out.print("Hydraulic erosion 3: ");
    ...
    public final static Channel erode4(Channel channel, float rain_amount, float vaporization, int rain_freq, int iterations) {
        Channel water_map = new Channel(channel.width, channel.height).fill(0f);
        Channel water_map_diff = new Channel(channel.width, channel.height).fill(0f);
        Channel height_map_diff = new Channel(channel.width, channel.height).fill(0f);

        System.out.print("Hydraulic erosion 4: ");
    ...
    public final static Channel erode5(Channel channel, Channel rain, float erosion_water, float erosion_flow, float evaporation, float water_threshold, float solulibility, int ipr, int iterations) {
        ...
        System.out.print("Hydraulic erosion 5: ");
