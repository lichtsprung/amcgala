...
import org.amcgala.framework.math.util.Maths;
 ...
 * and other matrix functions. The five decompositions are: <P><UL> <LI>Cholesky
 * Decomposition of symmetric, positive definite matrices. <LI>LU Decomposition
 * of rectangular matrices. <LI>QR Decomposition of rectangular matrices.
 * <LI>Singular Value Decomposition of rectangular matrices. <LI>Eigenvalue
 * Decomposition of both symmetric and nonsymmetric square matrices. </UL> <DL>
 * <DT><B>Example of use:</B></DT>
 * <p/>
 * <DD>Solve a linear system A x = b and compute the residual norm, ||b - A x||. <P><PRE>
...
public class Matrix implements Cloneable, java.io.Serializable {
    ...
    public Vector3d toVector3d() {
        return Vector3d.createVector3d(get(0, 0), get(1, 0), get(2, 0));
    }
}
