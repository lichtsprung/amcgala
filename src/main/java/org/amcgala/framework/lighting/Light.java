...
public class Light  {
	...
	/**
	 * Konstruktor für das Spotlight.
	 * @param name
	 * @param intensity
	 * @param reflexion
	 * @param winkel
	 */
	public Light(String name, double intensity, double reflexion, double winkel) {
		this.mode = "spotlight";
	 ...
	 * @return Der Modus der Lichtquelle (pointlight, ambientlight, spotlight)
	 */
	 ...
	 * @return Die Position der Lichtquelle
	 */
	 ...
	 * @return Die Parameter der Lichtquelle als String
	 */
	@Override
